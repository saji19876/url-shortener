...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Stat.user'
        db.delete_column('shortener_stat', 'user_id')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'Stat.user'
        db.add_column('shortener_stat', 'user', orm['shortener.stat:user'])
    ...
    models = {
        ...
        'shortener.link': {
            'date_submitted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 19, 1, 54, 40, 36152)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'shortener.stat': {
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 19, 1, 54, 40, 37711)'}),
