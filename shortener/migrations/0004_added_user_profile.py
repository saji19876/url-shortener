...
class Migration:
    ...
    models = {
        ...
        'shortener.link': {
            'date_submitted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 25, 1, 16, 18, 60170)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'shortener.stat': {
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 25, 1, 16, 18, 61668)'}),
