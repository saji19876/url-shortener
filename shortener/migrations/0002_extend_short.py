...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Stat.stat_type'
        db.add_column('shortener_stat', 'stat_type', orm['shortener.stat:stat_type'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Stat.stat_type'
        db.delete_column('shortener_stat', 'stat_type')
    ...
    models = {
        ...
        'shortener.link': {
            'date_submitted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 19, 1, 20, 29, 912837)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'shortener.stat': {
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 19, 1, 20, 29, 914277)'}),
